...
public abstract class AbsGreedyBetweeness
{
	...
	protected DataWorkshopNFC m_dataWorkshop;	
         ...
         * @return
         */
	public AbsGreedyBetweeness(FastList<Index> candidates, DataWorkshopNFC dataWorkshop)
	{
    ...
    public abstract BasicSetInterface createEmptySet(DataWorkshopNFC dw, FastList<Index> candidates) throws Exception;

	public static Index[] findVertices(FastList<Index> candidates, int[] givenDeployment, DataWorkshopNFC dataWorkshop, Algorithm alg, Bound boundType, double bound, 
	...
	public static Index[] findVertices(FastList<Index> candidates, int[] givenVertices, AbstractSimpleEdge<Index,BasicVertexInfo>[] givenEdges, DataWorkshopNFC dataWorkshop, Algorithm alg, Bound boundType, double bound, 
