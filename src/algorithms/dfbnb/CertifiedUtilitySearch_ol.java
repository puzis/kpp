 ...
 */
public class CertifiedUtilitySearch_ol<E> extends  BudgetedUtilitySearch_ol<E> {
	/**
	 * 
	 */
	...
	public CertifiedUtilitySearch_ol(InfNode<E> root, double budget) {
		super(root, budget);
	...
	public boolean isSearchDone() {
		return (m_openList.isEmpty() | m_certificate>=1);
	}
}
