...
public class GroupDegreeTest  extends TestCase
{
	...
	public GroupDegreeTest(String arg0){	super(arg0);	}
    ...
    public void testGroupDegree()
    {
    	...
    	vs = new Object[3];
    	vs[0] = Index.valueOf(3);	vs[1] = Index.valueOf(1);	vs[2] = Index.valueOf(2);  
    	assertEquals(7, GroupDegreeAlgorithm.calculateMixedGroupDegree(vs, m_graph, new DummyProgress(), 1));
    }
    ...
    public void testSumOfGroup() throws Exception
    {
    	...
    	group = new Index[2];
    	group[0] = Index.valueOf(0);	group[1] = Index.valueOf(1);
    	assertEquals(7.0, GroupDegreeAlgorithm.calculateSumGroup(group, m_graph, new DummyProgress(), 1));
    	
    	group = new Index[3];
    	group[0] = Index.valueOf(0);	group[1] = Index.valueOf(1);	group[2] = Index.valueOf(7);
    ...
    public void testAddition() throws Exception
    {
    	...
    	members.add(Index.valueOf(1));	members.add(Index.valueOf(2));
    	add(members, 6);
    	members = new FastList<Index>();
    	members.add(Index.valueOf(2));	members.add(Index.valueOf(8));
    	add(members, 8);
    	members = new FastList<Index>();
    	members.add(Index.valueOf(1));	members.add(Index.valueOf(2));	members.add(Index.valueOf(3));
    	add(members, 7);
    	members = new FastList<Index>();
    	members.add(Index.valueOf(0));	members.add(Index.valueOf(1));	members.add(Index.valueOf(2));
    	add(members, 7);
    	members = new FastList<Index>();
    	members.add(Index.valueOf(4));	members.add(Index.valueOf(6));	members.add(Index.valueOf(8));
    	add(members, 9);
    	members = new FastList<Index>();
    	members.add(Index.valueOf(4));	members.add(Index.valueOf(2));	members.add(Index.valueOf(9));	members.add(Index.valueOf(8));
    	add(members, 10);
    	members = new FastList<Index>();
    	members.add(Index.valueOf(5));	members.add(Index.valueOf(3));	members.add(Index.valueOf(7));	members.add(Index.valueOf(1));
    	add(members, 8);
    }
    ...
    {
    	try{
    		int[] vertices = new int[m_graph.getNumberOfVertices()];	int i = 0;
			...
			Object[] result = alg.getOptimalGroupSizeBounded(m_vertices.size(), new int[0], new AbstractSimpleEdge[0], new DummyProgress(), 1);
			systemOut(result);
    	}
    	catch(Exception ex)
    	{
    ...
    public void testSorting() throws Exception
    {
    	...
    	given[0] = 1;
    	try{
    	Index[] result = topKDegreeAlg.getOptimalGroupSizeBounded(4, given, new AbstractSimpleEdge[0], new DummyProgress(), 1);
    	systemOut(result);
    	}catch(Exception ex){
    		System.out.println(ex);
    	}
    	
    	FastList<AbstractSimpleEdge<Index,BasicVertexInfo>> pairs = new FastList<AbstractSimpleEdge<Index,BasicVertexInfo>>();
    	AbstractSimpleEdge<Index,BasicVertexInfo>[] givenPairs = new AbstractSimpleEdge[1];
    	...
    	givenPairs[0] = (AbstractSimpleEdge<Index,BasicVertexInfo>)m_graph.getEdge(Index.valueOf(7), Index.valueOf(8));
    	...
    	try{
    	AbstractSimpleEdge<Index,BasicVertexInfo>[] resultLinks = topKDegreeAlg.getOptimalEdgesSizeBounded(4, new int[0], givenPairs, new DummyProgress(), 1);
