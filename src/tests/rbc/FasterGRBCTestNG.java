...
public class FasterGRBCTestNG extends GRBCTestNG {
/**
 ...
 */
	...
	public void testDelta() throws Exception{
    	...
    	FasterGRBC fgrbcAlg = new FasterGRBC(g_line, cw, null, ShadowedHistoriedCacheArr.CACHEID);
    	for (int i=0; i<g_line.getDeltaValues().length; i++){
    		...
    		double actual = fgrbcAlg.getDelta(v1, seq, v2);
    	...
    	fgrbcAlg = new FasterGRBC(g_middleV, cw, null, ShadowedHistoriedCacheArr.CACHEID);
    	...
    	fgrbcAlg = new FasterGRBC(g_crossedCircle, cw, null, ShadowedHistoriedCacheArr.CACHEID);
