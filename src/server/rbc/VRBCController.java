...
public class VRBCController {
	public static final String ALIAS = "VRBC";
	...
	public int create(int netID,String communicationWeightsStr){
		...
		if (graph != null)
		{
		    ...
		    vrbc = new VRBCAlgorithm(graph,communicationWeights);
		}
		int algID = DataBase.putAlgorithm(vrbc, netID);
		return algID; 
	}
	...
	public  double getBetweenness(int algID, int v) {
		VRBCAlgorithm vrbc = (VRBCAlgorithm)DataBase.getAlgorithm(algID);
		...
		double res=vrbc.getBetweeness(Index.valueOf(v));
		return res;
	}
	...
	public  double getTargetDependency(int algID, int v, int t) {
		...
		return vrbc.getTargetDependency(Index.valueOf(v), Index.valueOf(t));
	}
	...
	public  double getSourceDependency(int algID, int s,int v) {
		...
		return vrbc.getSourceDependency(Index.valueOf(s),Index.valueOf(v));
	}
	...
	public  double getDelta(int algID,int s, int v, int t) {
		...
		return vrbc.getDelta(Index.valueOf(s),Index.valueOf(v),Index.valueOf(t));
	}
