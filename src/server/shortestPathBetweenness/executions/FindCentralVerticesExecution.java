...
public class FindCentralVerticesExecution extends AbstractExecution
{
	...
	public FindCentralVerticesExecution(FastList<Index> candidates, int[] givenVertices, AbstractSimpleEdge<Index,BasicVertexInfo>[] givenEdges, DataWorkshop dataWorkshop, 
