...
@Path("/groupdegree")
public class GroupDegreeRest{

  private GroupDegreeController alg;

  public GroupDegreeRest() {
    alg = new GroupDegreeController();
  }
  ...
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Path("getGroupDegree")
  public double getGroupDegree(
    @FormParam("algID") int algID,
    @FormParam("vertices") IntArray vertices,
    @FormParam("edges") IntArray edges) {
    return alg.getGroupDegree(algID, toObjectArray(vertices), toObjectArray(edges));
  }
  @POST
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Path("getGroupDegreeAsynch")
  public int getGroupDegreeAsynch(
    @FormParam("algID") int algID,
    @FormParam("vertices") IntArray vertices,
    @FormParam("edges") IntArray edges) {
    return alg.getGroupDegreeAsynch(algID, toObjectArray(vertices), toObjectArray(edges));
  }
