...
import server.rbc.VRBCAlgorithmController;
...
@Path("/vrbcalgorithm")
//!!!!!!!!!!!!!!!!!!!!!!!!!!
public class VRBCAlgorithmRest {

  private VRBCAlgorithmController alg;

  public VRBCAlgorithmRest()
  {
    alg = new VRBCAlgorithmController();
  }
