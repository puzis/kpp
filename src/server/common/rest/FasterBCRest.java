...
public class FasterBCRest {

  private FasterBCController alg;

  public FasterBCRest()
  {
    alg = new FasterBCController();
  }
  ...
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Path("createFromSE")
  public int createFromSE(
    @FormParam("netID") int netID,
    @FormParam("tmID") int tmID){
    return alg.createFromSE(netID, tmID);
  }
  ...
  @POST
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Path("createAsynch_tmID_bcCalculatorType")
  public int createAsynch_tmID_bcCalculatorType(
    @FormParam("netID") int netID,
    @FormParam("tmID") int tmID,
    @FormParam("bcCalculatorType") int bcCalculatorType) {
    return alg.createAsynch(netID, tmID, bcCalculatorType);
  }
  ...
  public DoubleArray getBetweennessVertices(
    ...
    return toDoubleArray(alg.getBetweenness(algID, toIntArray(vertices)));
  }
  ...
  @POST
  @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  @Path("getComponentsStatistics")
  public IntArray getComponentsStatistics(
    @FormParam("algID") int algID){
        return toIntArray(alg.getComponentsStatistics(algID));
  }
  ...
  public IntArray getComponents(
    @FormParam("algID") int algID){
        return toIntArray(alg.getComponents(algID));
  }
